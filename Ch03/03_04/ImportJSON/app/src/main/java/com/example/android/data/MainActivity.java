    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_import:
                ...
                // Declare a list of DataItem objects
                // To get the list of DataItems, assign "JSONHelper.importFromJSON(this);"
                // Assign dataItems variable to the return value of the method importFromJSON
                // from the JSONHelper class
                List<DataItem> dataItems = JSONHelper.importFromJSON(this);

                // If there are dataItems...
                if (dataItems != null) {
                    // Using a for each loop, display the name of each of the
                    // DataItems that was imported.
                    for (   // Create a dataItem object
                            DataItem dataItem:
                            // Loop through the dataItems collections
                            dataItems) {
