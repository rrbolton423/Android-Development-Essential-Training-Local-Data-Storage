...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // I'm no longer going to be using the sample data, so I'm going to comment
        // out this code below.
...
//        });
        ...
        // Then I'll declare a list of DataItem objects
        // This time I will call it listFromDB.
        // And I'll call mDataSource.getAllItems()
        // Retrieve the data from the Database and store it in a list
        List<DataItem> listFromDB = mDataSource.getAllItems();

        // Change the DataItemAdapter, and instead of using the SampleData, I'll use listFromDB.
        // Display the data
