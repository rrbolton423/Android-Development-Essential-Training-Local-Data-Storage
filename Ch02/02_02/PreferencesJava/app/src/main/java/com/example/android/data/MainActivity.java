        ...
        if (resultCode == RESULT_OK && requestCode == SIGNIN_REQUEST) {
            ...
            SharedPreferences.Editor editor =
                    getSharedPreferences(
                            // Name of the preference set where you want to save the data
                            MY_GLOBAL_PREFS,
                            // constant mode
                            // SP are always private to the application
                            MODE_PRIVATE
                            )
                            // return the editor object
                            .edit();

            // take value from SigninActivity and save it in the preferences
