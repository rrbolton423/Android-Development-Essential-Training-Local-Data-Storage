...
public class SampleDataProvider {
    ...
    // Instances of my new DataItem class
    public static List<DataItem> dataItemList;

    // Instance of the map interface,
    // The Map interface has 2 generic declarations,
    // 1: key, 2: the associated value
    // In this app , each data item will be referenced
    // by its primary key (type String), and the key will
    // reference the full data item (DataItem)
    public static Map<String, DataItem> dataItemMap;

    // These are static fields, to initialize them, I'll need
    ...
    // static method that accepts an instance of the dataItem class,
    // and adds it to both the List and the Map.
    private static void addItem(DataItem item) {
        // Both collections have references to the single item
