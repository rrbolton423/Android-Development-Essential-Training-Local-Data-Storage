...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ask whether there's already data in the database.
        // This executes the method and returns a numeric value
        int itemCount = db.dataItemDao().countItems();

        // Then I'll check the value
        // If itemCount has a value of 0, I want to insert that data.
        if (itemCount == 0) {

            // Get the data from a resource file
        ...
        } else { // But if there is already data in the db, I won't do anything

            // Logcat output
            Log.i(TAG, "onCreate: data already exists");
        }

        // So you now have a working SQLite database defined and managed with significantly
        // less code than you might've used with Android's classic SQLite management tools.
        // Each time you run the application, you're checking to see whether the data already
        // exists, and if it doesn't already exist, you're inserting it from the static resource
        // file. You're ready to start retrieving data from the database for display in your app.
        checkPermissions();        
